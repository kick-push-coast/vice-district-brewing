...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Check out our industrial-chic taproom space on Michigan Avenue. Available for private reservations and tours on request.">
  ...
  <body>
	...
	<div class="main container">
		...
		<?php perch_content('Taproom Info'); ?>

      <?php perch_content('The Mission'); ?>

      <?php perch_content('The Name'); ?>
